...
export const Education = () => {
    return (
      <div className="relative bg-body lg:w-[82%] lg:ml-auto flex justify-center items-center py-10 p-4 text-gray-100">
        {/* Top Shadow */}
        ...
        <div className="w-full sm:px-2 space-y-8 z-10 ">
          {educationDetails.map((education, index) => (
            <div key={index} className="p-4 sm:p-3 rounded-lg shadow-[0_8px_16px_rgba(0,0,0,0.95)] space-y-6 ">
              {/* Section Title */}
              <div className="flex justify-between items-start lg:w-[80%] lg:m-auto ">
                <div>
              ...
              {education.universities && (
                <div>
                  <p className="text-sm lg:text-base text-gray-400 font-semibold lg:w-[80%] lg:m-auto">Universities:</p>
                  <ul className="mt-2 space-y-4">
                    {education.universities.map((university, idx) => (
                      <li key={idx} className="flex justify-between items-center text-sm lg:text-base lg:w-[80%] lg:m-auto">
                        <div>
