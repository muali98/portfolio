...
export const Main = () => {
    return (
        <>
            <h1 className="text-red-400 text-center tracking-wide text-sm md:text-xl ml-2 mr-2 lg:mr-10 ml-10">This website is under development by Muhammad Ali, he is currently extremely busy with telecom core network projects! &emsp;  Until the full website is coded, please scroll down to see the resume!</h1>
