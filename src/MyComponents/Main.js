...
export const Main = () => {
    return (
        <>
            <h1 className="text-red-400 text-center tracking-wide text-sm md:text-xl ml-3 lg:ml-10 mr-3 lg:mr-9">This website is under development by Muhammad Ali, he is currently busy with telecom core network projects! &emsp;  Until the full website is coded, please scroll down to see the resume!</h1>
            ...
            <div className='flex sm:hidden'>
                <div>
                <img src={Image2} alt="my profile1" className="" />
                <h1 className="mb-4 text-lg font-extrabold text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">○ Electronics/Embedded Systems</h1>
                <h1 className="mb-4 text-lg font-extrabold text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">○ Core Networks/Telecom Cloud</h1>
                </div>
            </div>
